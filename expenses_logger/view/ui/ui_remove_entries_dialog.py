...
################################################################################
## Form generated from reading UI file 'remove_entries_dialog.ui'
##
...
class Ui_RemoveEntriesDialog(object):
    def setupUi(self, RemoveEntriesDialog):
        ...
        sizePolicy.setHeightForWidth(RemoveEntriesDialog.sizePolicy().hasHeightForWidth())
        RemoveEntriesDialog.setSizePolicy(sizePolicy)
        RemoveEntriesDialog.setMinimumSize(QSize(470, 200))
        RemoveEntriesDialog.setMaximumSize(QSize(470, 200))
        RemoveEntriesDialog.setStyleSheet(u"QFrame{border: 2px outset black;}\n"
"\n"
"QLabel\n"
"{\n"
"border: 0px;\n"
"}")
        self.verticalLayout_2 = QVBoxLayout(RemoveEntriesDialog)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.frame = QFrame(RemoveEntriesDialog)
        ...
        self.retranslateUi(RemoveEntriesDialog)

        QMetaObject.connectSlotsByName(RemoveEntriesDialog)
    # setupUi

    def retranslateUi(self, RemoveEntriesDialog):
        RemoveEntriesDialog.setWindowTitle("")
        self.label_text.setText(QCoreApplication.translate("RemoveEntriesDialog", u"<html><head/><body><p>Ausgew\u00e4hlte Eintr\u00e4ge entfernen?</p></body></html>", None))
        self.pushButton_yes.setText(QCoreApplication.translate("RemoveEntriesDialog", u"Ja", None))
        self.pushButton_no.setText(QCoreApplication.translate("RemoveEntriesDialog", u"Nein", None))
    # retranslateUi
